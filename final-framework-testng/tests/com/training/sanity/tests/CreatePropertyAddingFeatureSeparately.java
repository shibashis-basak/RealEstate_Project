...
public class CreatePropertyAddingFeatureSeparately {
	...
	@Test
	public void createPropertyAddingFeatureSeparately() throws InterruptedException {
		...
		featuresPOM.clickAddNewFeature();
		featuresPOM.clickAddNew();
		
		addnewPOM.sendTitle("prestige");
		addnewPOM.sendContent("home town");
		addnewPOM.selectFeature("New Launches");
		addnewPOM.scrollup();
		addnewPOM.clickOnPublish();
		
		Thread.sleep(5000);
		//screenShot.captureScreenShot("RETC_041");
	}
}
