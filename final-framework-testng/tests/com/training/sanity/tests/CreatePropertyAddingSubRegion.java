...
public class CreatePropertyAddingSubRegion {
	...
	@Test
	public void createPropertyAddingSubRegion() throws InterruptedException {
		...
		addnewPOM.addNewRegion("   West Bangalore", "Electronic city");
		addnewPOM.sendTitle("prestige");
		addnewPOM.sendContent("home town");
		addnewPOM.selectSubRegion("West Bangalore", "Electronic city");
